...
$MESS["MESS_COUPON_PLACEHOLDER"] = "Введите промокод";
$MESS["MESS_COUPON_ACTIVE"] = "Применить";
...
$MESS['PERSONAL_REQUEST'] = 'Нажимая кнопку «Оформить заказ», я даю своё согласие на обработку моих персональных данных, в соответствии с Федеральным законом от 27.07.2006 года № 152-ФЗ «О персональных данных», на условиях и для целей, определённых <a href="/privacy/">в политике конфиденциальности</a>';
$MESS['NEED_CALL_TITLE'] = 'Нужен звонок менеджера';
$MESS['CONFIRM_ORDER_TITLE'] = 'Заказ оформлен';
$MESS['STATUS_ORDER_TEXT'] = 'Статус заказа можно узнать в личном кабинете или по телефону 8 (800) 302-52-16';
